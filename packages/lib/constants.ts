...
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Calx.mu, Inc.";
...
export const LOGO = "/Calx.mu-black.svg";
export const LOGO_ICON = "/Calx-word-black.svg";
